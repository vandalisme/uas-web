...
if(isset($_GET['action'])){
    if($_GET['action']=='hapus'){
        ...
        $hasil=mysql_query("DELETE FROM tb_transaksi WHERE id_transaksi='$id_transaksi'");
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="mb-3" style="margin-top: 4%;">History Transaction</h1>
        <div class="row">
            <div class="col-md-12">
                <div class="card-body">
                    <div class="table-responsive text-center">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                $sql=mysql_query("SELECT * FROM tb_transaksi WHERE id_user='$_SESSION[id]' GROUP BY id_transaksi ORDER BY tanggal_transaksi DESC");
                                $no=1;
