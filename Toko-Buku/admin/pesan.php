...
if(isset($_GET['hapus'])) {
    ...
    $hasil=mysql_query("DELETE FROM tb_pesan WHERE id_pesan='$id_pesan'");
    if($hasil){
...
<div class="container">
    ...
    <h1 class="mt-4 mb-3">Manage Pesan</h1>
    <ol class="breadcrumb">
            ...
            <div class="card-body">
                <div class="table-responsive text-center">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                            $sql=mysql_query("SELECT * FROM tb_pesan ORDER BY tanggal_kirim DESC");
                            $no=1;
